    ...
    <>
      ...
      <section id="home">
        ...
        <div className="opacity-0 translate-y-10 body body1" style={{ color: 'whitesmoke' }}>
          ...
          <h1 style={{  fontFamily: 'montserrat', fontSize:'3rem' }}>UI/UX Designer and Developer</h1>
        ...
        <div className="project-grid">
          ...
          <Project
            ...
            description="It is a MERN stack application for hackathon score management, featuring an admin dashboard for team and project management, judge scoring, CSV upload functionality, and leaderboard generation."
            demoLink="https://hackathon-platform-frontend.onrender.com/"
            githubLink="https://github.com/Riddhi050803/hackathon-score-platform"
          />
        </div>
        </section>
